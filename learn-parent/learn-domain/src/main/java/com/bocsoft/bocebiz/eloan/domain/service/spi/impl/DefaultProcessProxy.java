...
public class DefaultProcessProxy implements InvocationHandler {
	...
	private DefaultProcessProxy(Object concreteService,  ProcessRouteTableFactory routeTableFactory, ExtensionProcessFactory extensionFactory) {
	...
	public static Object proxy(Object concreteService, ProcessRouteTableFactory routeTableFactory, ExtensionProcessFactory extensionFactory) {
